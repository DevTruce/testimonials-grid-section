...
<h3 align="center">Testimonials Grid Section</h3>
  ...
  <p align="center">
    FEM Challenge
    <br />
    <a href="https://github.com/DevTruce/testimonials-grid-section" target="_blank"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://devtruce.github.io/testimonials-grid-section/" target="_blank">View Demo</a>
    ·
    <a href="https://github.com/DevTruce/testimonials-grid-section/issues" target="_blank">Report Bug</a>
    ·
    <a href="https://github.com/DevTruce/testimonials-grid-section/issues" target="_blank">Request Feature</a>
  </p>
</div>
...
1. Clone the repo
   ```sh
   git clone https://github.com/DevTruce/testimonials-grid-section.git
   ```
...
[issues-link]: https://github.com/DevTruce/testimonials-grid-section/issues
[license-link]: https://github.com/DevTruce/testimonials-grid-section/blob/master/LICENSE.txt
...
[issues-icon]: https://img.shields.io/github/issues/DevTruce/testimonials-grid-section.svg?style=for-the-badge
[license-icon]: https://img.shields.io/github/license/DevTruce/testimonials-grid-section.svg?style=for-the-badge
